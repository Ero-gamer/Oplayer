...
internal val MingCuteRemove: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.Remove",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f,
        autoMirror = false,
            ...
            addPath(
                pathData = PathParser().parsePathString("M8 12h8m5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z").toNodes(),
