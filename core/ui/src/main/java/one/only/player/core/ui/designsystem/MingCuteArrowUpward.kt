...
internal val MingCuteArrowUpward: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.ArrowUpward",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f,
        ...
        addPath(
            pathData = PathParser().parsePathString("M12 20V5m-5.657 5L12 4.343 17.657 10").toNodes(),
