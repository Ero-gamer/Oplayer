...
internal val MingCuteExpandMore: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.ExpandMore",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f,
        autoMirror = false,
            ...
            addPath(
                pathData = PathParser().parsePathString("M17.657 9.343 12 15 6.343 9.343").toNodes(),
