...
internal val MingCuteUpSmall: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.UpSmall",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f,
        ...
        addPath(
            pathData = PathParser().parsePathString("M9.17157 12.9998L12 10.1714L14.8284 12.9998").toNodes(),
