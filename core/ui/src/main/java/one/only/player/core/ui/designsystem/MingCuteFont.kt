...
internal val MingCuteFont: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.Font",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        addPath(
            pathData = PathParser().parsePathString("m5 20 6.312-15.537a.743.743 0 0 1 1.376 0L19 20M7.031 15h9.938").toNodes(),
