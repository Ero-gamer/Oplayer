...
internal val MingCuteEdit: ImageVector by lazy {
    ImageVector.Builder(
        name = "MingCute.Edit",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        autoMirror = false,
            ...
            addPath(
                pathData = PathParser().parsePathString("M20 11v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h8m7 0L10 14").toNodes(),
